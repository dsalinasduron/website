...
public class Asteroids extends Game {
	...
	private java.util.List<Asteroid> randomAsteroids = new ArrayList<Asteroid>();
		private ArrayList<Bullet> bulletRemovals = new ArrayList<Bullet>();

		private java.util.List<Asteroid> asteroidRemovals = new ArrayList<Asteroid>();
