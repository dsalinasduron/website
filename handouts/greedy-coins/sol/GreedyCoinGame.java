...
public class GreedyCoinGame {
	...
	public CoinGame(String file) throws FileNotFoundException {
	...
	public void playGame() {
		...
		if (redScore > blueScore) {
			...
			computerChoice = list.getLength() - 1;
		}

		while (!list.isEmpty()) {

			System.out.println("I choose " + list.get(computerChoice));
	...
	public static void main(String[] args) throws IOException {
		...
		CoinGame game = new CoinGame(args[0]);
